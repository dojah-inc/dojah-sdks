...
import { TzKycApiCustom } from "./tz-kyc-api-custom";
/**
...
export const TzKycApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getNin: async (appId?: string, firstName?: string, lastName?: string, dateOfBirth?: string, mothersLastName?: string, mothersFirstName?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const TzKycApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getNin(requestParameters: TzKycApiGetNinRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNin(requestParameters.appId, requestParameters.firstName, requestParameters.lastName, requestParameters.dateOfBirth, requestParameters.mothersLastName, requestParameters.mothersFirstName, options);
...
/**
 * TzKycApi - object-oriented interface
 * @export
 * @class TzKycApi
 * @extends {BaseAPI}
 */
export class TzKycApi extends TzKycApiCustom {
    /**
     * 
     * @summary Lookup TZ NIN
     * @param {TzKycApiGetNinRequest} requestParameters Request parameters.
