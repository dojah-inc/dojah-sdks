...
import { ZwKycApiCustom } from "./zw-kyc-api-custom";
/**
...
export const ZwKycApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        checkCredit: async (appId?: string, idNumber?: string, name?: string, surname?: string, gender?: string, dob?: string, maritalStatus?: string, mobileNumber?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        verifyId: async (appId?: string, id?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ZwKycApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async checkCredit(requestParameters: ZwKycApiCheckCreditRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ZwKycCheckCreditResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.checkCredit(requestParameters.appId, requestParameters.idNumber, requestParameters.name, requestParameters.surname, requestParameters.gender, requestParameters.dob, requestParameters.maritalStatus, requestParameters.mobileNumber, options);
        ...
        async verifyId(requestParameters: ZwKycApiVerifyIdRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ZwKycVerifyIdResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.verifyId(requestParameters.appId, requestParameters.id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ZwKycApi - object-oriented interface
 * @export
 * @class ZwKycApi
 * @extends {BaseAPI}
 */
export class ZwKycApi extends ZwKycApiCustom {
    /**
     * 
     * @summary Credit Check
     * @param {ZwKycApiCheckCreditRequest} requestParameters Request parameters.
