...
public class GetTransactionResponseEntity {
  ...
  public GetTransactionResponseEntity walletId(String walletId) {
  ...
  **/
  ...
  public GetTransactionResponseEntity transactionAmount(Double transactionAmount) {
  ...
  public GetTransactionResponseEntity transactionAmount(Integer transactionAmount) {
  ...
  **/
  ...
  public GetTransactionResponseEntity transactionType(String transactionType) {
  ...
  **/
  ...
  public GetTransactionResponseEntity recipientAccountNumber(String recipientAccountNumber) {
  ...
  **/
  ...
  public GetTransactionResponseEntity senderAccountNumber(String senderAccountNumber) {
  ...
  **/
  ...
  public GetTransactionResponseEntity transactionRemarks(String transactionRemarks) {
  ...
  **/
  ...
  public GetTransactionResponseEntity transactionReason(String transactionReason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "wallet has Insufficient balance", value = "")
  ...
  public GetTransactionResponseEntity transactionId(String transactionId) {
  ...
  **/
  ...
  public GetTransactionResponseEntity transactionStatus(String transactionStatus) {
  ...
  **/
  ...
  public GetTransactionResponseEntity dateCreated(String dateCreated) {
  ...
  **/
   ...
   * @return the GetTransactionResponseEntity instance itself
   */
  public GetTransactionResponseEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GetTransactionResponseEntity getTransactionResponseEntity = (GetTransactionResponseEntity) o;
    return Objects.equals(this.walletId, getTransactionResponseEntity.walletId) &&
        Objects.equals(this.transactionAmount, getTransactionResponseEntity.transactionAmount) &&
        Objects.equals(this.transactionType, getTransactionResponseEntity.transactionType) &&
        Objects.equals(this.recipientAccountNumber, getTransactionResponseEntity.recipientAccountNumber) &&
        Objects.equals(this.senderAccountNumber, getTransactionResponseEntity.senderAccountNumber) &&
        Objects.equals(this.transactionRemarks, getTransactionResponseEntity.transactionRemarks) &&
        Objects.equals(this.transactionReason, getTransactionResponseEntity.transactionReason) &&
        Objects.equals(this.transactionId, getTransactionResponseEntity.transactionId) &&
        Objects.equals(this.transactionStatus, getTransactionResponseEntity.transactionStatus) &&
        Objects.equals(this.dateCreated, getTransactionResponseEntity.dateCreated)&&
        Objects.equals(this.additionalProperties, getTransactionResponseEntity.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTransactionResponseEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTransactionResponseEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTransactionResponseEntity is not found in the empty JSON string", GetTransactionResponseEntity.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTransactionResponseEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTransactionResponseEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTransactionResponseEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTransactionResponseEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTransactionResponseEntity>() {
           @Override
           public void write(JsonWriter out, GetTransactionResponseEntity value) throws IOException {
           ...
           @Override
           public GetTransactionResponseEntity read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GetTransactionResponseEntity instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetTransactionResponseEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTransactionResponseEntity
  * @throws IOException if the JSON string is invalid with respect to GetTransactionResponseEntity
  */
  public static GetTransactionResponseEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTransactionResponseEntity.class);
  }

 /**
  * Convert an instance of GetTransactionResponseEntity to an JSON string
  *
  * @return JSON string
  */
