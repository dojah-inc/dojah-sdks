...
import com.konfigthis.dojah.client.model.GetWebhooksResponseEntityInner;
...
public class GetWebhooksResponse {
  ...
  private List<GetWebhooksResponseEntityInner> entity = null;

  public GetWebhooksResponse() {
  }

  public GetWebhooksResponse entity(List<GetWebhooksResponseEntityInner> entity) {
    
    this.entity = entity;
    return this;
  }

  public GetWebhooksResponse addEntityItem(GetWebhooksResponseEntityInner entityItem) {
    if (this.entity == null) {
  ...
  **/
  ...
  public List<GetWebhooksResponseEntityInner> getEntity() {
    return entity;
  }


  public void setEntity(List<GetWebhooksResponseEntityInner> entity) {
    this.entity = entity;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entity, getWebhooksResponse.entity)&&
      ...
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        ...
        if (jsonArrayentity != null) {
          ...
          for (int i = 0; i < jsonArrayentity.size(); i++) {
            GetWebhooksResponseEntityInner.validateJsonObject(jsonArrayentity.get(i).getAsJsonObject());
          };
        }
      }
  }
