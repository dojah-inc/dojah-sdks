...
public class MlApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MlApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public MlApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call verifyPhotoIdWithSelfieCall(MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call verifyPhotoIdWithSelfieValidateBeforeCall(MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest, final ApiCallback _callback) throws ApiException {
        ...
        return verifyPhotoIdWithSelfieCall(mlVerifyPhotoIdWithSelfieRequest, _callback);

    }


    private ApiResponse<Object> verifyPhotoIdWithSelfieWithHttpInfo(MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest) throws ApiException {
        okhttp3.Call localVarCall = verifyPhotoIdWithSelfieValidateBeforeCall(mlVerifyPhotoIdWithSelfieRequest, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call verifyPhotoIdWithSelfieAsync(MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyPhotoIdWithSelfieValidateBeforeCall(mlVerifyPhotoIdWithSelfieRequest, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
    ...
    public class VerifyPhotoIdWithSelfieRequestBuilder {
        ...
        public Object execute() throws ApiException {
            MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest = buildBodyParams();
            ApiResponse<Object> localVarResp = verifyPhotoIdWithSelfieWithHttpInfo(mlVerifyPhotoIdWithSelfieRequest);
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest = buildBodyParams();
            return verifyPhotoIdWithSelfieWithHttpInfo(mlVerifyPhotoIdWithSelfieRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            MlVerifyPhotoIdWithSelfieRequest mlVerifyPhotoIdWithSelfieRequest = buildBodyParams();
            return verifyPhotoIdWithSelfieAsync(mlVerifyPhotoIdWithSelfieRequest, _callback);
        }
    }
