...
public class AuthenticationApiGenerated {
    ...
    private okhttp3.Call sendOtpCall(AuthenticationSendOtpRequest authenticationSendOtpRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sendOtpValidateBeforeCall(AuthenticationSendOtpRequest authenticationSendOtpRequest, final ApiCallback _callback) throws ApiException {
        ...
        return sendOtpCall(authenticationSendOtpRequest, _callback);

    }


    private ApiResponse<AuthenticationSendOtpResponse> sendOtpWithHttpInfo(AuthenticationSendOtpRequest authenticationSendOtpRequest) throws ApiException {
        okhttp3.Call localVarCall = sendOtpValidateBeforeCall(authenticationSendOtpRequest, null);
        Type localVarReturnType = new TypeToken<AuthenticationSendOtpResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call sendOtpAsync(AuthenticationSendOtpRequest authenticationSendOtpRequest, final ApiCallback<AuthenticationSendOtpResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendOtpValidateBeforeCall(authenticationSendOtpRequest, _callback);
        Type localVarReturnType = new TypeToken<AuthenticationSendOtpResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class SendOtpRequestBuilder {
        ...
        public AuthenticationSendOtpResponse execute() throws ApiException {
            AuthenticationSendOtpRequest authenticationSendOtpRequest = buildBodyParams();
            ApiResponse<AuthenticationSendOtpResponse> localVarResp = sendOtpWithHttpInfo(authenticationSendOtpRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<AuthenticationSendOtpResponse> executeWithHttpInfo() throws ApiException {
            AuthenticationSendOtpRequest authenticationSendOtpRequest = buildBodyParams();
            return sendOtpWithHttpInfo(authenticationSendOtpRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AuthenticationSendOtpResponse> _callback) throws ApiException {
            AuthenticationSendOtpRequest authenticationSendOtpRequest = buildBodyParams();
            return sendOtpAsync(authenticationSendOtpRequest, _callback);
        }
    }
    ...
    private ApiResponse<AuthenticationValidateOtpResponse> validateOtpWithHttpInfo(String referenceId, Integer code) throws ApiException {
    ...
    private okhttp3.Call validateOtpAsync(String referenceId, Integer code, final ApiCallback<AuthenticationValidateOtpResponse> _callback) throws ApiException {
    ...
    public class ValidateOtpRequestBuilder {
        ...
        public AuthenticationValidateOtpResponse execute() throws ApiException {
            ApiResponse<AuthenticationValidateOtpResponse> localVarResp = validateOtpWithHttpInfo(referenceId, code);
            return localVarResp.getResponseBody();
        }
