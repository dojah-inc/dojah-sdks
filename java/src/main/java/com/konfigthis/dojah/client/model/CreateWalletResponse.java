...
import com.konfigthis.dojah.client.model.CreateWalletResponseEntity;
...
public class CreateWalletResponse {
  ...
  private CreateWalletResponseEntity entity;

  public CreateWalletResponse() {
  }

  public CreateWalletResponse entity(CreateWalletResponseEntity entity) {
  ...
  **/
  ...
  public CreateWalletResponseEntity getEntity() {
    return entity;
  }


  public void setEntity(CreateWalletResponseEntity entity) {
    this.entity = entity;
  }
   ...
   * @return the CreateWalletResponse instance itself
   */
  public CreateWalletResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entity, createWalletResponse.entity)&&
        Objects.equals(this.additionalProperties, createWalletResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateWalletResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWalletResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull()) {
        CreateWalletResponseEntity.validateJsonObject(jsonObj.getAsJsonObject("entity"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateWalletResponse>() {
           ...
           public CreateWalletResponse read(JsonReader in) throws IOException {
             ...
             CreateWalletResponse instance = thisAdapter.fromJsonTree(jsonObj);
