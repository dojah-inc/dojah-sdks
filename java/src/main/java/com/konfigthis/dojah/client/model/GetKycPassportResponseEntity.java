...
public class GetKycPassportResponseEntity {
  ...
  public static final String SERIALIZED_NAME_ISSUE_PLACE = "issue_place";
  @SerializedName(SERIALIZED_NAME_ISSUE_PLACE)
  ...
  public GetKycPassportResponseEntity() {
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "A00123456", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "01/02/2000", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Standard Passport", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MOSES", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAEBAQEBAQEBA", value = "")
   ...
   * @return the GetKycPassportResponseEntity instance itself
   */
  public GetKycPassportResponseEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GetKycPassportResponseEntity getKycPassportResponseEntity = (GetKycPassportResponseEntity) o;
    return Objects.equals(this.passportNumber, getKycPassportResponseEntity.passportNumber) &&
        Objects.equals(this.dateOfIssue, getKycPassportResponseEntity.dateOfIssue) &&
        Objects.equals(this.expiryDate, getKycPassportResponseEntity.expiryDate) &&
        Objects.equals(this.documentType, getKycPassportResponseEntity.documentType) &&
        Objects.equals(this.issuePlace, getKycPassportResponseEntity.issuePlace) &&
        Objects.equals(this.surname, getKycPassportResponseEntity.surname) &&
        Objects.equals(this.firstName, getKycPassportResponseEntity.firstName) &&
        Objects.equals(this.otherNames, getKycPassportResponseEntity.otherNames) &&
        Objects.equals(this.dateOfBirth, getKycPassportResponseEntity.dateOfBirth) &&
        Objects.equals(this.gender, getKycPassportResponseEntity.gender) &&
        Objects.equals(this.photo, getKycPassportResponseEntity.photo)&&
        Objects.equals(this.additionalProperties, getKycPassportResponseEntity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(passportNumber, dateOfIssue, expiryDate, documentType, issuePlace, surname, firstName, otherNames, dateOfBirth, gender, photo, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetKycPassportResponseEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetKycPassportResponseEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetKycPassportResponseEntity is not found in the empty JSON string", GetKycPassportResponseEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("issue_place") != null && !jsonObj.get("issue_place").isJsonNull()) && !jsonObj.get("issue_place").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `issue_place` to be a primitive type in the JSON string but got `%s`", jsonObj.get("issue_place").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetKycPassportResponseEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetKycPassportResponseEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetKycPassportResponseEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetKycPassportResponseEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<GetKycPassportResponseEntity>() {
           @Override
           public void write(JsonWriter out, GetKycPassportResponseEntity value) throws IOException {
           ...
           @Override
           public GetKycPassportResponseEntity read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GetKycPassportResponseEntity instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetKycPassportResponseEntity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetKycPassportResponseEntity
  * @throws IOException if the JSON string is invalid with respect to GetKycPassportResponseEntity
  */
  public static GetKycPassportResponseEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetKycPassportResponseEntity.class);
  }

 /**
  * Convert an instance of GetKycPassportResponseEntity to an JSON string
  *
  * @return JSON string
  */
