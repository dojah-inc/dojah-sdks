...
public class ZwKycApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ZwKycApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public ZwKycApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call checkCreditCall(String appId, String idNumber, String name, String surname, String gender, String dob, String maritalStatus, Integer mobileNumber, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call checkCreditValidateBeforeCall(String appId, String idNumber, String name, String surname, String gender, String dob, String maritalStatus, Integer mobileNumber, final ApiCallback _callback) throws ApiException {
        return checkCreditCall(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber, _callback);

    }


    private ApiResponse<ZwKycCheckCreditResponse> checkCreditWithHttpInfo(String appId, String idNumber, String name, String surname, String gender, String dob, String maritalStatus, Integer mobileNumber) throws ApiException {
        okhttp3.Call localVarCall = checkCreditValidateBeforeCall(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber, null);
        Type localVarReturnType = new TypeToken<ZwKycCheckCreditResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call checkCreditAsync(String appId, String idNumber, String name, String surname, String gender, String dob, String maritalStatus, Integer mobileNumber, final ApiCallback<ZwKycCheckCreditResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkCreditValidateBeforeCall(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber, _callback);
        Type localVarReturnType = new TypeToken<ZwKycCheckCreditResponse>(){}.getType();
    ...
    public class CheckCreditRequestBuilder {
         ...
         */
        public CheckCreditRequestBuilder appId(String appId) {
            this.appId = appId;
            return this;
        }
        ...
        public ZwKycCheckCreditResponse execute() throws ApiException {
            ApiResponse<ZwKycCheckCreditResponse> localVarResp = checkCreditWithHttpInfo(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber);
        ...
        public ApiResponse<ZwKycCheckCreditResponse> executeWithHttpInfo() throws ApiException {
            return checkCreditWithHttpInfo(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ZwKycCheckCreditResponse> _callback) throws ApiException {
            return checkCreditAsync(appId, idNumber, name, surname, gender, dob, maritalStatus, mobileNumber, _callback);
        }
    }
    ...
    private okhttp3.Call verifyIdCall(String appId, String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyIdValidateBeforeCall(String appId, String id, final ApiCallback _callback) throws ApiException {
        return verifyIdCall(appId, id, _callback);

    }


    private ApiResponse<ZwKycVerifyIdResponse> verifyIdWithHttpInfo(String appId, String id) throws ApiException {
        okhttp3.Call localVarCall = verifyIdValidateBeforeCall(appId, id, null);
        Type localVarReturnType = new TypeToken<ZwKycVerifyIdResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call verifyIdAsync(String appId, String id, final ApiCallback<ZwKycVerifyIdResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyIdValidateBeforeCall(appId, id, _callback);
        Type localVarReturnType = new TypeToken<ZwKycVerifyIdResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class VerifyIdRequestBuilder {
         ...
         */
        public VerifyIdRequestBuilder appId(String appId) {
            this.appId = appId;
            return this;
        }
        ...
        public ZwKycVerifyIdResponse execute() throws ApiException {
            ApiResponse<ZwKycVerifyIdResponse> localVarResp = verifyIdWithHttpInfo(appId, id);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ZwKycVerifyIdResponse> executeWithHttpInfo() throws ApiException {
            return verifyIdWithHttpInfo(appId, id);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ZwKycVerifyIdResponse> _callback) throws ApiException {
            return verifyIdAsync(appId, id, _callback);
        }
    }
