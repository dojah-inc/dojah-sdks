...
public class PurchaseApi {
    ...
    public PurchaseApi() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PurchaseApi(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call sendAirtimeCall(PurchaseAirtimeRequest purchaseAirtimeRequest, String appId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call sendAirtimeValidateBeforeCall(PurchaseAirtimeRequest purchaseAirtimeRequest, String appId, final ApiCallback _callback) throws ApiException {
        ...
        return sendAirtimeCall(purchaseAirtimeRequest, appId, _callback);

    }


    private ApiResponse<PurchaseAirtimeResponse> sendAirtimeWithHttpInfo(PurchaseAirtimeRequest purchaseAirtimeRequest, String appId) throws ApiException {
        okhttp3.Call localVarCall = sendAirtimeValidateBeforeCall(purchaseAirtimeRequest, appId, null);
        Type localVarReturnType = new TypeToken<PurchaseAirtimeResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call sendAirtimeAsync(PurchaseAirtimeRequest purchaseAirtimeRequest, String appId, final ApiCallback<PurchaseAirtimeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendAirtimeValidateBeforeCall(purchaseAirtimeRequest, appId, _callback);
        Type localVarReturnType = new TypeToken<PurchaseAirtimeResponse>(){}.getType();
    ...
    public class SendAirtimeRequestBuilder {
         ...
         * @return SendAirtimeRequestBuilder
         */
        public SendAirtimeRequestBuilder appId(String appId) {
            this.appId = appId;
            return this;
        }
        ...
        public PurchaseAirtimeResponse execute() throws ApiException {
            PurchaseAirtimeRequest purchaseAirtimeRequest = buildBodyParams();
            ApiResponse<PurchaseAirtimeResponse> localVarResp = sendAirtimeWithHttpInfo(purchaseAirtimeRequest, appId);
        ...
        public ApiResponse<PurchaseAirtimeResponse> executeWithHttpInfo() throws ApiException {
            PurchaseAirtimeRequest purchaseAirtimeRequest = buildBodyParams();
            return sendAirtimeWithHttpInfo(purchaseAirtimeRequest, appId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<PurchaseAirtimeResponse> _callback) throws ApiException {
            PurchaseAirtimeRequest purchaseAirtimeRequest = buildBodyParams();
            return sendAirtimeAsync(purchaseAirtimeRequest, appId, _callback);
        }
    }
