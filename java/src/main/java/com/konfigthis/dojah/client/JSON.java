...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AmlScreenAmlRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AmlScreenAmlResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AmlScreenAmlResponseEntity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AuthenticationSendOtpRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AuthenticationSendOtpResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AuthenticationSendOtpResponseEntityInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AuthenticationValidateOtpResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.AuthenticationValidateOtpResponseEntity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetEmailReputationResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetEmailReputationResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetEmailReputationResponseEntityBreachDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetEmailReputationResponseEntityDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetEmailReputationResponseEntityDomainDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntityReport.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntityReportAnonymity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntityReportBlacklists.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntityReportInformation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudGetIpReputationResponseEntityReportRiskScore.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenPhoneResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenPhoneResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityEmailCheckResult.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityEmailCheckResultBreachDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityEmailCheckResultBreachDetailsBreachesInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityEmailCheckResultDomainDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityIpCheckResult.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityIpCheckResultAnonymity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityIpCheckResultBlacklists.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityIpCheckResultIpDetails.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityIpCheckResultRiskScore.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.FraudScreenUserResponseEntityPhoneCheckResult.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KybGetCacResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KybGetCacResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KybGetTinResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KybGetTinResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycCheckLivenessRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressResponseEntityData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressResponseEntityDataApplicant.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.KycSubmitAddressResponseEntityDataNeighbor.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.MlVerifyPhotoIdWithSelfieRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.NigeriaKycGetNinResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.NigeriaKycGetNinResponseEntity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.VerificationsVerifySelfieNinRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.VerificationsVerifySelfieVninRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZafKycGetIdResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZafKycGetIdResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZwKycCheckCreditResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZwKycCheckCreditResponseEntity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZwKycVerifyIdResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.dojah.client.model.ZwKycVerifyIdResponseEntity.CustomTypeAdapterFactory());
