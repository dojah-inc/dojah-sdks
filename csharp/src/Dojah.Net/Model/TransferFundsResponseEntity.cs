...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferFundsResponse_entity")]
    public partial class TransferFundsResponseEntity : IEquatable<TransferFundsResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferFundsResponseEntity" /> class.
        /// </summary>
        ...
        public TransferFundsResponseEntity(string walletId = default(string), decimal transactionAmount = default(decimal), string transactionType = default(string), string recipientAccountNumber = default(string), string senderAccountNumber = default(string), string transactionRemarks = default(string), string transactionReason = default(string), string transactionId = default(string), string transactionStatus = default(string), string dateCreated = default(string))
        {
        ...
        {
            return this.Equals(input as TransferFundsResponseEntity);
        }

        /// <summary>
        /// Returns true if TransferFundsResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferFundsResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferFundsResponseEntity input)
        {
            if (input == null)
            {
                return false;
