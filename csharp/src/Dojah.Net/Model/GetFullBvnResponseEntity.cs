...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFullBvnResponse_entity")]
    public partial class GetFullBvnResponseEntity : IEquatable<GetFullBvnResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFullBvnResponseEntity" /> class.
        /// </summary>
        ...
        public GetFullBvnResponseEntity(string title = default(string), string bvn = default(string), string dateOfBirth = default(string), string email = default(string), string enrollmentBank = default(string), string enrollmentBranch = default(string), string firstName = default(string), string gender = default(string), string image = default(string), string lastName = default(string), string levelOfAccount = default(string), string lgaOfOrigin = default(string), string lgaOfResidence = default(string), string maritalStatus = default(string), string middleName = default(string), string nameOnCard = default(string), string nationality = default(string), string nin = default(string), string phoneNumber1 = default(string), string phoneNumber2 = default(string), string reference = default(string), string registrationDate = default(string), string residentialAddress = default(string), string stateOfOrigin = default(string), string stateOfResidence = default(string), string watchListed = default(string))
        {
            this.Title = title;
            this.Bvn = bvn;
        ...
        {
            return this.Equals(input as GetFullBvnResponseEntity);
        }

        /// <summary>
        /// Returns true if GetFullBvnResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of GetFullBvnResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetFullBvnResponseEntity input)
        {
            if (input == null)
            {
                return false;
