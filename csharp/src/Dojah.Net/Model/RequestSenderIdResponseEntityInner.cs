...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RequestSenderIdResponse_entity_inner")]
    public partial class RequestSenderIdResponseEntityInner : IEquatable<RequestSenderIdResponseEntityInner>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RequestSenderIdResponseEntityInner);
        }

        /// <summary>
        /// Returns true if RequestSenderIdResponseEntityInner instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestSenderIdResponseEntityInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestSenderIdResponseEntityInner input)
        {
            if (input == null)
            {
                return false;
