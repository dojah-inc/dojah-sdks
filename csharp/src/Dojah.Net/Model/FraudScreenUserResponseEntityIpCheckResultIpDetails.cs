...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FraudScreenUserResponse_entity_ip_check_result_ip_details")]
    public partial class FraudScreenUserResponseEntityIpCheckResultIpDetails : IEquatable<FraudScreenUserResponseEntityIpCheckResultIpDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FraudScreenUserResponseEntityIpCheckResultIpDetails" /> class.
        /// </summary>
        ...
        public FraudScreenUserResponseEntityIpCheckResultIpDetails(string reverseDns = default(string), string continentCode = default(string), string continentName = default(string), string countryCode = default(string), string countryName = default(string), string countryCurrency = default(string), string countryCallingCode = default(string), string regionName = default(string), string cityName = default(string), decimal latitude = default(decimal), decimal longitude = default(decimal), string isp = default(string), string asn = default(string))
        {
        ...
        {
            return this.Equals(input as FraudScreenUserResponseEntityIpCheckResultIpDetails);
        }

        /// <summary>
        /// Returns true if FraudScreenUserResponseEntityIpCheckResultIpDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of FraudScreenUserResponseEntityIpCheckResultIpDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudScreenUserResponseEntityIpCheckResultIpDetails input)
        {
            if (input == null)
            {
                return false;
