...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FraudScreenUserResponse_entity_phone_check_result")]
    public partial class FraudScreenUserResponseEntityPhoneCheckResult : IEquatable<FraudScreenUserResponseEntityPhoneCheckResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FraudScreenUserResponseEntityPhoneCheckResult" /> class.
        /// </summary>
        ...
        public FraudScreenUserResponseEntityPhoneCheckResult(decimal number = default(decimal), bool valid = default(bool), bool disposable = default(bool), string type = default(string), string country = default(string), string carrier = default(string), decimal score = default(decimal), List<string> accountDetailsRegistered = default(List<string>))
        {
            this.Number = number;
            this.Valid = valid;
        ...
        {
            return this.Equals(input as FraudScreenUserResponseEntityPhoneCheckResult);
        }

        /// <summary>
        /// Returns true if FraudScreenUserResponseEntityPhoneCheckResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FraudScreenUserResponseEntityPhoneCheckResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudScreenUserResponseEntityPhoneCheckResult input)
        {
            if (input == null)
            {
                return false;
