...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCacResponse_entity")]
    public partial class GetCacResponseEntity : IEquatable<GetCacResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCacResponseEntity" /> class.
        /// </summary>
        /// <param name="rcNumber">rcNumber.</param>
        /// <param name="companyName">companyName.</param>
        /// <param name="address">address.</param>
        /// <param name="dateOfRegistration">dateOfRegistration.</param>
        public GetCacResponseEntity(string rcNumber = default(string), string companyName = default(string), string address = default(string), string dateOfRegistration = default(string))
        {
        ...
        {
            return this.Equals(input as GetCacResponseEntity);
        }

        /// <summary>
        /// Returns true if GetCacResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCacResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCacResponseEntity input)
        {
            if (input == null)
            {
                return false;
