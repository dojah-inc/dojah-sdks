...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FraudScreenUserResponse_entity_ip_check_result_anonymity")]
    public partial class FraudScreenUserResponseEntityIpCheckResultAnonymity : IEquatable<FraudScreenUserResponseEntityIpCheckResultAnonymity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FraudScreenUserResponseEntityIpCheckResultAnonymity" /> class.
        /// </summary>
        ...
        public FraudScreenUserResponseEntityIpCheckResultAnonymity(bool isProxy = default(bool), bool isWebproxy = default(bool), bool isVpn = default(bool), bool isHosting = default(bool), bool isTor = default(bool))
        {
        ...
        {
            return this.Equals(input as FraudScreenUserResponseEntityIpCheckResultAnonymity);
        }

        /// <summary>
        /// Returns true if FraudScreenUserResponseEntityIpCheckResultAnonymity instances are equal
        /// </summary>
        /// <param name="input">Instance of FraudScreenUserResponseEntityIpCheckResultAnonymity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudScreenUserResponseEntityIpCheckResultAnonymity input)
        {
            if (input == null)
            {
                return false;
