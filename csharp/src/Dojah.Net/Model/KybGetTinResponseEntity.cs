...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KybGetTinResponse_entity")]
    public partial class KybGetTinResponseEntity : IEquatable<KybGetTinResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KybGetTinResponseEntity" /> class.
        /// </summary>
        ...
        public KybGetTinResponseEntity(string search = default(string), string taxpayerName = default(string), string cACRegNo = default(string), string fIRSTIN = default(string), string jITTIN = default(string), string taxOffice = default(string), string phoneNo = default(string), string email = default(string))
        {
            this.Search = search;
        ...
        {
            return this.Equals(input as KybGetTinResponseEntity);
        }

        /// <summary>
        /// Returns true if KybGetTinResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of KybGetTinResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KybGetTinResponseEntity input)
        {
            if (input == null)
            {
                return false;
