...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreditSubwalletResponse_entity")]
    public partial class CreditSubwalletResponseEntity : IEquatable<CreditSubwalletResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditSubwalletResponseEntity" /> class.
        /// </summary>
        ...
        public CreditSubwalletResponseEntity(string walletId = default(string), decimal transactionAmount = default(decimal), string transactionType = default(string), string recipientAccountNumber = default(string), string senderAccountNumber = default(string), string transactionRemarks = default(string), string transactionReason = default(string), string transactionId = default(string), string transactionStatus = default(string), string dateCreated = default(string))
        {
        ...
        {
            return this.Equals(input as CreditSubwalletResponseEntity);
        }

        /// <summary>
        /// Returns true if CreditSubwalletResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditSubwalletResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditSubwalletResponseEntity input)
        {
            if (input == null)
            {
                return false;
