...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPremiumBvnResponse_entity")]
    public partial class GetPremiumBvnResponseEntity : IEquatable<GetPremiumBvnResponseEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPremiumBvnResponseEntity" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetPremiumBvnResponseEntity);
        }

        /// <summary>
        /// Returns true if GetPremiumBvnResponseEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPremiumBvnResponseEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPremiumBvnResponseEntity input)
        {
            if (input == null)
            {
                return false;
