...
namespace Dojah.Net.Model
{
    ...
    /// SendSmsRequest
    /// </summary>
    [DataContract(Name = "SendSmsRequest")]
    public partial class SendSmsRequest : IEquatable<SendSmsRequest>, IValidatableObject
    {
        ...
        public SendSmsRequest(string destination = default(string), string message = default(string), string channel = default(string), string senderId = default(string))
        {
