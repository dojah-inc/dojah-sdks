...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MlVerifyPhotoIdWithSelfieRequest")]
    public partial class MlVerifyPhotoIdWithSelfieRequest : IEquatable<MlVerifyPhotoIdWithSelfieRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MlVerifyPhotoIdWithSelfieRequest" /> class.
        /// </summary>
        /// <param name="selfieImage">selfieImage.</param>
        /// <param name="photoidImage">photoidImage.</param>
        public MlVerifyPhotoIdWithSelfieRequest(string selfieImage = default(string), string photoidImage = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MlVerifyPhotoIdWithSelfieRequest {\n");
        ...
        {
            return this.Equals(input as MlVerifyPhotoIdWithSelfieRequest);
        }

        /// <summary>
        /// Returns true if MlVerifyPhotoIdWithSelfieRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MlVerifyPhotoIdWithSelfieRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MlVerifyPhotoIdWithSelfieRequest input)
        {
            if (input == null)
            {
                return false;
