...
namespace Dojah.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FraudGetEmailReputationResponse_entity_domain_details")]
    public partial class FraudGetEmailReputationResponseEntityDomainDetails : IEquatable<FraudGetEmailReputationResponseEntityDomainDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FraudGetEmailReputationResponseEntityDomainDetails" /> class.
        /// </summary>
        ...
        public FraudGetEmailReputationResponseEntityDomainDetails(string domain = default(string), string tld = default(string), bool registered = default(bool), string created = default(string), string updated = default(string), string expires = default(string), string registrarName = default(string), string registeredTo = default(string), bool disposable = default(bool), bool free = default(bool), bool custom = default(bool), bool dmarcEnforced = default(bool), bool spfStrict = default(bool), bool validMx = default(bool), bool acceptAll = default(bool), bool suspiciousTld = default(bool), bool websiteExists = default(bool))
        {
            this.Domain = domain;
            this.Tld = tld;
        ...
        /// </summary>
        [DataMember(Name = "registered_to", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as FraudGetEmailReputationResponseEntityDomainDetails);
        }

        /// <summary>
        /// Returns true if FraudGetEmailReputationResponseEntityDomainDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of FraudGetEmailReputationResponseEntityDomainDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FraudGetEmailReputationResponseEntityDomainDetails input)
        {
            if (input == null)
            {
                return false;
