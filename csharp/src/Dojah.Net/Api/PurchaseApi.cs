...
namespace Dojah.Net.Api
{
    ...
    public partial class PurchaseApi : IPurchaseApi
    {
        ...
        /// <returns></returns>
        public PurchaseApi(Dojah.Net.Client.Configuration configuration)
        {
        ...
        public PurchaseApi(Dojah.Net.Client.ISynchronousClient client, Dojah.Net.Client.IAsynchronousClient asyncClient, Dojah.Net.Client.IReadableConfiguration configuration)
        {
        ...
        public Dojah.Net.Client.ApiResponse<PurchaseAirtimeResponse> SendAirtimeWithHttpInfo(PurchaseAirtimeRequest purchaseAirtimeRequest, string appId = default(string), int operationIndex = 0)
        {
            ...
            {
                throw new Dojah.Net.Client.ApiException(400, "Missing required parameter 'purchaseAirtimeRequest' when calling PurchaseApi->SendAirtime");
            }
            ...
            {
                Exception _exception = this.ExceptionFactory("SendAirtime", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
