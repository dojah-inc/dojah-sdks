...
namespace Dojah.Net.Api
{
    ...
    public interface IGHKYCApiSync : IApiAccessor
    {
        ...
        Object GetVoter(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0);
        ...
        ApiResponse<Object> GetVoterWithHttpInfo(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0);
    ...
    public interface IGHKYCApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> GetVoterAsync(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetVoterWithHttpInfoAsync(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GHKYCApi : IGHKYCApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Object</returns>
        public Object GetVoter(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0)
        {
            Dojah.Net.Client.ApiResponse<Object> localVarResponse = GetVoterWithHttpInfo(id, fullName, isNewId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object</returns>
        public Dojah.Net.Client.ApiResponse<Object> GetVoterWithHttpInfo(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0)
        {
            Dojah.Net.Client.RequestOptions localVarRequestOptions = new Dojah.Net.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> GetVoterAsync(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Dojah.Net.Client.ApiResponse<Object> localVarResponse = await GetVoterWithHttpInfoAsync(id, fullName, isNewId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Dojah.Net.Client.ApiResponse<Object>> GetVoterWithHttpInfoAsync(int? id = default(int?), string fullName = default(string), bool? isNewId = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
