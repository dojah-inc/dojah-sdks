...
from dojah_client.model.zw_kyc_check_credit_response import ZwKycCheckCreditResponse as ZwKycCheckCreditResponseSchema

from dojah_client.type.zw_kyc_check_credit_response import ZwKycCheckCreditResponse

from . import path

# Query params
IdNumberSchema = schemas.StrSchema
NameSchema = schemas.StrSchema
SurnameSchema = schemas.StrSchema
GenderSchema = schemas.StrSchema
DobSchema = schemas.StrSchema
MaritalStatusSchema = schemas.StrSchema
MobileNumberSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'id_number': typing.Union[IdNumberSchema, str, ],
        'name': typing.Union[NameSchema, str, ],
        'surname': typing.Union[SurnameSchema, str, ],
        'gender': typing.Union[GenderSchema, str, ],
        'dob': typing.Union[DobSchema, str, ],
        'marital_status': typing.Union[MaritalStatusSchema, str, ],
        'mobile_number': typing.Union[MobileNumberSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_mobile_number = api_client.QueryParameter(
    name="mobile_number",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = ZwKycCheckCreditResponseSchema
