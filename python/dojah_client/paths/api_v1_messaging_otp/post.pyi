...
from dojah_client.model.authentication_send_otp_request import AuthenticationSendOtpRequest as AuthenticationSendOtpRequestSchema
from dojah_client.model.authentication_send_otp_response import AuthenticationSendOtpResponse as AuthenticationSendOtpResponseSchema
...
request_body_authentication_send_otp_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AuthenticationSendOtpResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: AuthenticationSendOtpResponse
...
class BaseApi(api_client.Api):
    ...
    async def _asend_otp_oapg(
        ...
        serialized_data = request_body_authentication_send_otp_request.serialize(body, content_type)
