...
class BaseApi(api_client.Api):
    ...
    def _get_address_verification_mapped_args(
        self,
    ...
    async def _aget_address_verification_oapg(
        self,
    ...
    def _get_address_verification_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetAddressVerification(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_address_verification(
        self,
        reference_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_address_verification_mapped_args(
            reference_id=reference_id,
        )
        return await self._aget_address_verification_oapg(
    ...
    def get_address_verification(
        ...
        return self._get_address_verification_oapg(
            query_params=args.query,
        )
