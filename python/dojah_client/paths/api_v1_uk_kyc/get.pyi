...
class BaseApi(api_client.Api):
    ...
    def _uk_two_plus_two_mapped_args(
        self,
    ...
    async def _auk_two_plus_two_oapg(
        self,
...
class UkTwoPlusTwo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def auk_two_plus_two(
        self,
        country: typing.Optional[str] = None,
        first_name: typing.Optional[str] = None,
        last_name: typing.Optional[str] = None,
        ...
        args = self._uk_two_plus_two_mapped_args(
            country=country,
        ...
        return await self._auk_two_plus_two_oapg(
    ...
    def uk_two_plus_two(
        ...
        return self._uk_two_plus_two_oapg(
            query_params=args.query,
        )
