...
from dojah_client.model.nigeria_kyc_get_nin_response import NigeriaKycGetNinResponse as NigeriaKycGetNinResponseSchema

from dojah_client.type.nigeria_kyc_get_nin_response import NigeriaKycGetNinResponse

from . import path

# Query params
NinSchema = schemas.IntSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'nin': typing.Union[NinSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_nin = api_client.QueryParameter(
    name="nin",
...
SchemaFor200ResponseBodyApplicationJson = NigeriaKycGetNinResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_nin_mapped_args(
        self,
        nin: typing.Optional[int] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        if nin is not None:
            _query_params["nin"] = nin
