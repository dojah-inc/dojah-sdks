...
from dojah_client.model.ml_verify_photo_id_with_selfie_request import MlVerifyPhotoIdWithSelfieRequest as MlVerifyPhotoIdWithSelfieRequestSchema

from dojah_client.type.ml_verify_photo_id_with_selfie_request import MlVerifyPhotoIdWithSelfieRequest
...
request_body_ml_verify_photo_id_with_selfie_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _averify_photo_id_with_selfie_oapg(
        ...
        serialized_data = request_body_ml_verify_photo_id_with_selfie_request.serialize(body, content_type)
