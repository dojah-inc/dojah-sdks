...
class VerifySelfieBvnResponseEntity(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def selfie_verification() -> typing.Type['VerifySelfieBvnResponseEntitySelfieVerification']:
                return VerifySelfieBvnResponseEntitySelfieVerification
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["selfie_verification"]) -> 'VerifySelfieBvnResponseEntitySelfieVerification': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bvn", "date_of_birth", "email", "enrollment_bank", "enrollment_branch", "first_name", "gender", "image", "last_name", "level_of_account", "lga_of_origin", "lga_of_residence", "marital_status", "middle_name", "name_on_card", "nin", "phone_number1", "phone_number2", "registration_date", "residential_address", "selfie_verification", "state_of_origin", "state_of_residence", "watch_listed", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["selfie_verification"]) -> typing.Union['VerifySelfieBvnResponseEntitySelfieVerification', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        selfie_verification: typing.Union['VerifySelfieBvnResponseEntitySelfieVerification', schemas.Unset] = schemas.unset,
