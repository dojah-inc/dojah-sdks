<a name="__pageTop"></a>
# dojah_client.apis.tags.kyc_api.KYCApi

All URIs are relative to *https://api.dojah.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**check_liveness**](#check_liveness) | **post** /api/v1/ml/liveness | Liveness Check
[**get_accounts**](#get_accounts) | **get** /api/v1/kyc/accounts | KYC - Fetch Accounts 
[**get_address_verification**](#get_address_verification) | **get** /api/v1/kyc/address | Fetch Address Verification Data
[**get_bvn_from_nuban**](#get_bvn_from_nuban) | **get** /api/v1/kyc/nuban/bvn | Lookup BVN from NUBAN
[**get_vin**](#get_vin) | **get** /api/v1/kyc/vin | KYC - Get VIN
[**submit_address**](#submit_address) | **post** /api/v1/kyc/address | Submit Address
...
------------- | ------------- | -------------
[**KycCheckLivenessRequest**](../../models/KycCheckLivenessRequest.md) |  | 
...
200 | [ApiResponseFor200](#check_liveness.ApiResponseFor200) | Successful response

#### check_liveness.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
try:
    # KYC - Fetch Accounts
    get_accounts_response = dojah.kyc.get_accounts(
        bvn="22342291445 ",  # optional
    )
    pprint(get_accounts_response.headers)
    pprint(get_accounts_response.status)
    pprint(get_accounts_response.round_trip_time)
except ApiException as e:
    print("Exception when calling KYCApi.get_accounts: %s\n" % e)
    pprint(e.body)
    pprint(e.headers)
    pprint(e.status)
    pprint(e.reason)
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_accounts.ApiResponseFor200) | Successful response

#### get_accounts.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
try:
    # Fetch Address Verification Data
    get_address_verification_response = dojah.kyc.get_address_verification(
        reference_id="69e10264-4b90-64fe-b4b7-c9dddafd0241",  # optional
    )
    pprint(get_address_verification_response.headers)
    pprint(get_address_verification_response.status)
    pprint(get_address_verification_response.round_trip_time)
except ApiException as e:
    print("Exception when calling KYCApi.get_address_verification: %s\n" % e)
    pprint(e.body)
    pprint(e.headers)
    pprint(e.status)
    pprint(e.reason)
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_address_verification.ApiResponseFor200) | Successful response

#### get_address_verification.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
try:
    # Lookup BVN from NUBAN
    get_bvn_from_nuban_response = dojah.kyc.get_bvn_from_nuban(
        bank_code=57,  # optional
        account_number=2174879334,  # optional
    )
    pprint(get_bvn_from_nuban_response.headers)
    pprint(get_bvn_from_nuban_response.status)
    pprint(get_bvn_from_nuban_response.round_trip_time)
except ApiException as e:
    print("Exception when calling KYCApi.get_bvn_from_nuban: %s\n" % e)
    pprint(e.body)
    pprint(e.headers)
    pprint(e.status)
    pprint(e.reason)
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_bvn_from_nuban.ApiResponseFor200) | Successful response

#### get_bvn_from_nuban.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
try:
    # KYC - Get VIN
    get_vin_response = dojah.kyc.get_vin(
        vin="90F5B20205096041114",  # optional
    )
    pprint(get_vin_response.body)
    pprint(get_vin_response.body["entity"])
    pprint(get_vin_response.headers)
    pprint(get_vin_response.status)
    pprint(get_vin_response.round_trip_time)
except ApiException as e:
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#get_vin.ApiResponseFor200) | OK

#### get_vin.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
Type | Description  | Notes
------------- | ------------- | -------------
[**GetVinResponse**](../../models/GetVinResponse.md) |  | 
...
try:
    # Submit Address
    submit_address_response = dojah.kyc.submit_address(
        street="Aso Rock Villa",  # optional
        lga="Maitamia",  # optional
        state="FCT",  # optional
        landmark="Big Rock",  # optional
        first_name="",  # optional
        last_name="",  # optional
    ...
    pprint(submit_address_response.body)
    pprint(submit_address_response.body["entity"])
    pprint(submit_address_response.headers)
    pprint(submit_address_response.status)
    pprint(submit_address_response.round_trip_time)
except ApiException as e:
    print("Exception when calling KYCApi.submit_address: %s\n" % e)
    pprint(e.body)
    pprint(e.headers)
    pprint(e.status)
    pprint(e.reason)
...
Type | Description  | Notes
------------- | ------------- | -------------
[**KycSubmitAddressRequest**](../../models/KycSubmitAddressRequest.md) |  | 
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#submit_address.ApiResponseFor200) | OK

#### submit_address.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
Type | Description  | Notes
------------- | ------------- | -------------
[**KycSubmitAddressResponse**](../../models/KycSubmitAddressResponse.md) |  | 
