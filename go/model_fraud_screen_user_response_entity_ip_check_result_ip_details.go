...
func NewFraudScreenUserResponseEntityIpCheckResultIpDetails() *FraudScreenUserResponseEntityIpCheckResultIpDetails {
	this := FraudScreenUserResponseEntityIpCheckResultIpDetails{}
	return &this
}
...
func (o *FraudScreenUserResponseEntityIpCheckResultIpDetails) GetReverseDnsOk() (*string, bool) {
	if o == nil || isNil(o.ReverseDns) {
    return nil, false
	}
...
func (o *FraudScreenUserResponseEntityIpCheckResultIpDetails) HasCountryName() bool {
	if o != nil && !isNil(o.CountryName) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *FraudScreenUserResponseEntityIpCheckResultIpDetails) GetLatitudeOk() (*float32, bool) {
	if o == nil || isNil(o.Latitude) {
    return nil, false
	}
...
func (o *FraudScreenUserResponseEntityIpCheckResultIpDetails) SetIsp(v string) {
	o.Isp = &v
}
...
func (o FraudScreenUserResponseEntityIpCheckResultIpDetails) MarshalJSON() ([]byte, error) {
...
type NullableFraudScreenUserResponseEntityIpCheckResultIpDetails struct {
	value *FraudScreenUserResponseEntityIpCheckResultIpDetails
	isSet bool
}

func (v NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) Get() *FraudScreenUserResponseEntityIpCheckResultIpDetails {
	return v.value
}

func (v *NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) Set(val *FraudScreenUserResponseEntityIpCheckResultIpDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFraudScreenUserResponseEntityIpCheckResultIpDetails(val *FraudScreenUserResponseEntityIpCheckResultIpDetails) *NullableFraudScreenUserResponseEntityIpCheckResultIpDetails {
	return &NullableFraudScreenUserResponseEntityIpCheckResultIpDetails{value: val, isSet: true}
}

func (v NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFraudScreenUserResponseEntityIpCheckResultIpDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
