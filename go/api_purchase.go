...
func (r PurchaseApiSendAirtimeRequest) Execute() (*PurchaseAirtimeResponse, *http.Response, error) {
	return r.ApiService.SendAirtimeExecute(r)
}
...
*/
func (a *PurchaseApiService) SendAirtime() PurchaseApiSendAirtimeRequest {
	return PurchaseApiSendAirtimeRequest{
		ApiService: a,
...
func (a *PurchaseApiService) SendAirtimeExecute(r PurchaseApiSendAirtimeRequest) (*PurchaseAirtimeResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PurchaseApiService.SendAirtime")
	if err != nil {
	...
	if r.purchaseAirtimeRequest == nil {
		return localVarReturnValue, nil, reportError("purchaseAirtimeRequest is required and must be specified")
	}
