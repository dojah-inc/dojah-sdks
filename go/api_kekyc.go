...
*/
func (a *KEKYCApiService) GetPassport() KEKYCApiGetPassportRequest {
	return KEKYCApiGetPassportRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
	}
...
func (a *KEKYCApiService) GetPassportExecute(r KEKYCApiGetPassportRequest) (map[string]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KEKYCApiService.GetPassport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ke/kyc/passport"
